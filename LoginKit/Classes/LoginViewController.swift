...
extension LoginViewController {
    ...
    func setupValidation() {
        setupValidationOn(field: emailTextField, rules: ValidationService.nonBlankRules)
        setupValidationOn(field: passwordTextField, rules: ValidationService.nonBlankRules)
    }
