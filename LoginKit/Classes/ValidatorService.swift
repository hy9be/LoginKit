...
struct ValidationService {
    ...
    static var nonBlankRules: ValidationRuleSet<String> {
        var nonBlankRules = ValidationRuleSet<String>()
        nonBlankRules.add(rule: ValidationRuleLength(min: 1, error: ValidationError.nonBlank))
        return nonBlankRules
    }
